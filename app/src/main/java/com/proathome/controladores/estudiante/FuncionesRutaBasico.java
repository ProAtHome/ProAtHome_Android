...
public class FuncionesRutaBasico {
    ...
    public void desbloquearB1(){
        ...
        RutaBasico.btnB1_Bloque6.setIcon(this.contexto.getDrawable(R.drawable.ok));
        RutaBasico.btnB1_Bloque6.setIconSize(50);
    }

    public void desbloquearB2(){
        ...
        RutaBasico.btnB2_Bloque6.setIcon(this.contexto.getDrawable(R.drawable.ok));
        RutaBasico.btnB2_Bloque6.setIconSize(50);
    }

    public void desbloquearB3(){
        ...
        RutaBasico.btnB3_Bloque7.setIcon(this.contexto.getDrawable(R.drawable.ok));
        RutaBasico.btnB3_Bloque7.setIconSize(50);
    }

    public void desbloquearB4(){
    ...
    public void bloquearB2_B5(){
        RutaBasico.btnB2_Bloque1.setEnabled(false);
        RutaBasico.btnB2_Bloque1.setIcon(this.contexto.getDrawable(R.drawable.nivel_lock));
        RutaBasico.btnB2_Bloque1.setIconSize(50);
        ...
        RutaBasico.btnB3_Bloque1.setEnabled(false);
        RutaBasico.btnB3_Bloque1.setIcon(this.contexto.getDrawable(R.drawable.nivel_lock));
        RutaBasico.btnB3_Bloque1.setIconSize(50);
        ...
        RutaBasico.btnB4_Bloque1.setEnabled(false);
        RutaBasico.btnB4_Bloque1.setIcon(this.contexto.getDrawable(R.drawable.nivel_lock));
        RutaBasico.btnB4_Bloque1.setIconSize(50);
        ...
        RutaBasico.btnB5_Bloque1.setEnabled(false);
        RutaBasico.btnB5_Bloque1.setIcon(this.contexto.getDrawable(R.drawable.nivel_lock));
        RutaBasico.btnB5_Bloque1.setIconSize(50);
