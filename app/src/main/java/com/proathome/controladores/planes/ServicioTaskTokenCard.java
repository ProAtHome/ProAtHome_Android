    ...
    protected String doInBackground(Void... voids) {
        ...
        Constants.openpay.createToken(card, new OperationCallBack<Token>() {
            ...
            public void onSuccess(OperationResult<Token> operationResult) {
                ServicioTaskCobro servicioTaskCobro = new ServicioTaskCobro(contexto, DatosBancoPlanFragment.deviceIdString, DatosBancoPlanFragment.idSesion, DatosBancoPlanFragment.idEstudiante, operationResult.getResult().getId(), DatosBancoPlanFragment.costoTotal, ServicioTaskCobro.TOKEN_PHONE, ServicioTaskCobro.ENTENDIDO_TE);
