...
public class ServicioTaskGuardarProgreso extends AsyncTask<Void, Void, String> {
    ...
    public ServicioTaskGuardarProgreso(Context contexto, int idSesion, int idPerfil, int progreso, int progresoSegundos){
    ...
    protected String doInBackground(Void... voids) {
        ...
        Constants.wsURL_GUARDAR_PROGRESO = Constants.linkActualizarProgreso_GUARDAR_PROGRESO + Constants.idSesion_GUARDAR_PROGRESO + "/" + Constants.idPerfil_GUARDAR_PROGRESO + "/" + Constants.progreso_GUARDAR_PROGRESO + "/" + Constants.progresoSegundos_GUARDAR_PROGRESO;
        try{
