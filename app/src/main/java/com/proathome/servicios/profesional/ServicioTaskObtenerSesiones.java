...
public class ServicioTaskObtenerSesiones extends AsyncTask<Void, Void, String> {
    ...
    private int rangoServicio;

    public ServicioTaskObtenerSesiones(Context contexto, String linkAPI, int rangoServicio){
    ...
    protected String doInBackground(Void... voids) {
        ...
        try {
            URL url = new URL(this.linkAPI + "/" + this.rangoServicio);
