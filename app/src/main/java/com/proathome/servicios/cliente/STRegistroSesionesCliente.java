...
public class STRegistroSesionesCliente extends AsyncTask<Void, Void, String> {

    private Context contexto;
    private ProgressDialog progressDialog;
    public int idCliente, tiempo, idSeccion, idNivel, idBloque, personas;
    public String linkrequestAPI, horario, lugar, extras, tipoServicio, actualizado, fecha, tipoPlan, token;
    public double latitud,longitud;
    private boolean sumar;

    public STRegistroSesionesCliente(Context contexto, String linkAPI, int idCliente, String horario, String lugar,
    ...
    protected String doInBackground(Void... voids) {
        ...
        try{
            ...
            parametrosPOST.put("tipoServicio", this.tipoServicio);
