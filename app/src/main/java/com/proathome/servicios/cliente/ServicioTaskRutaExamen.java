...
public class ServicioTaskRutaExamen extends AsyncTask <Void, Void, String> {
    ...
    private int idCliente, idSeccion, idNivel, idBloque, horas;
    private boolean sumar;
    private String linkSumarServicio = Constants.IP + "/ProAtHome/apiProAtHome/cliente/nuevaRuta";

    public ServicioTaskRutaExamen(Context contexto, int idCliente, int idSeccion, int idNivel, int idBloque, int horas, boolean sumar){
