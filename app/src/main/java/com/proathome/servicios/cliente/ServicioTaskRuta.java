...
public class ServicioTaskRuta extends AsyncTask <Void, Void, String> {
    ...
    private int idCliente, estado, lugarRuta;

    public ServicioTaskRuta(Context contexto, int idCliente, int estado, int lugarRuta){
    ...
    protected String doInBackground(Void... voids) {
        ...
        if(this.estado == Constants.ESTADO_RUTA && this.lugarRuta == RutaFragment.SECCIONES){
            String wsURL = this.linkAPIEstadoRuta + this.idCliente + "/" + RutaFragment.SECCIONES;
            try{
            ...
            String wsURL = this.linkAPIEstadoRuta + this.idCliente + "/" + RutaBasico.NIVEL_BASICO;
            try{
                URL url = new URL(wsURL);
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
            ...
            String wsURL = this.linkAPIEstadoRuta + this.idCliente + "/" + RutaIntermedio.NIVEL_INTERMEDIO;
            try{
                URL url = new URL(wsURL);
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
            ...
            String wsURL = this.linkAPIEstadoRuta + this.idCliente + "/" + RutaAvanzado.NIVEL_AVANZADO;
            try{
                URL url = new URL(wsURL);
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
