...
public class ServicioTaskUpSesion extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... voids) {
        ...
        try{
            ...
            jsonDatos.put("tipoServicio", this.tipo);
    ...
    protected void onPostExecute(String s) {
        ...
        if(this.resultadoAPI != null){
            new SweetAlert(SesionesFragment.contexto, SweetAlert.SUCCESS_TYPE, SweetAlert.CLIENTE)
                    .setTitleText("¡GENIAL!")
                    .setContentText(this.resultadoAPI)
                    .show();
        }else{
            new SweetAlert(SesionesFragment.contexto, SweetAlert.ERROR_TYPE, SweetAlert.CLIENTE)
                    .setTitleText("¡ERROR!")
                    .setContentText("Error al actualizar el servicio.")
                    .show();
        }
    }
