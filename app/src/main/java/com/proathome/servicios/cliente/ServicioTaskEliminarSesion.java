...
public class ServicioTaskEliminarSesion extends AsyncTask<Void, Void, String> {
    ...
    private int idSesion, horas, idCliente;

    public ServicioTaskEliminarSesion(Context contexto, String linkAPI, int idSesion, int idCliente, String tipoPlan, int horas){
