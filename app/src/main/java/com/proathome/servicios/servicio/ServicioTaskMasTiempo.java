...
public class ServicioTaskMasTiempo extends AsyncTask<Void, Void, String> {
    ...
    private int idSesion, idCliente, progresoTotal;
    private String linkActivarTE = Constants.IP + "/ProAtHome/apiProAtHome/cliente/activarTE/";

    public ServicioTaskMasTiempo(Context contexto, int idSesion, int idCliente, int progresoTotal){
    ...
    protected String doInBackground(Void... voids) {
        ...
        try{
            ...
            URL url = new URL(this.linkActivarTE + this.idSesion + "/" + this.idCliente + "/" + this.progresoTotal);
