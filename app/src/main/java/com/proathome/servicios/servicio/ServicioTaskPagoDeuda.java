...
public class ServicioTaskPagoDeuda extends AsyncTask<Void, Void, String> {
    ...
    private String nombreCliente, correo, idCard, descripcion, deviceId;
    ...
    public ServicioTaskPagoDeuda(Context contexto, String nombreCliente, String correo, String idCard, double cobro, String descripcion, DialogFragment dialogFragment, int idSesion, String deviceId){
