...
public class ServicioTaskReportes extends AsyncTask<Void,Void,String> {
    ...
    public String linkAPIEstudiante = Constants.IP + "/ProAtHome/apiProAtHome/cliente/getReportes/";
    public String linkAPIProfesor = Constants.IP + "/ProAtHome/apiProAtHome/profesor/getReportes/";
