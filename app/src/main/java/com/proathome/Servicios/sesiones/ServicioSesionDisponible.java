...
import com.proathome.Views.cliente.fragments.MasTiempo;
...
public class ServicioSesionDisponible extends AsyncTask<Void, Void, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        if(s != null){
            ...
            Toast.makeText(Constants.contexto_DISPONIBILIDAD_PROGRESO, "Ocurrio un error, intente de nuevo mas tarde.", Toast.LENGTH_LONG).show();
    }
